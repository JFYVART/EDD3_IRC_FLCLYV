...
public class ClientConnectThread extends Thread {
	...
	private void acceptClient(Socket socket) throws IOException, InterruptedException {
		...
		String line = ClientServerProtocol.encodeProtocole_Ligne(loginUtilisateur, pwdUtilisateur, "",
				ClientServerProtocol.LOGIN_PWD, 0, "");
		dos.writeUTF(line);
		...
		if (isUserOK) {
			...
			line = ClientServerProtocol.encodeProtocole_Ligne(loginUtilisateur, pwdUtilisateur, "",
